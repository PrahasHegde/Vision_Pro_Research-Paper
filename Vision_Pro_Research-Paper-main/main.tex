...
\begin{figure*}[t!]
    ...
    \begin{subfigure}{0.5\textwidth}
        ...
        \begin{subfigure}{0.41\textwidth}
            ...
            \caption{\textbf{3D Reconstruction.} of facial depth by mesh.}
            \label{fig:sys1a}
        \end{subfigure}%
...
\begin{figure}[t!]
    ...
    \includegraphics[width=0.45\textwidth]{img/model_cf.png}
    \caption{\textbf{Confusion Matrix for YuNet + SFace.w} Demonstrating perfect accuracy and low error.}
    \label{fig:cf}
\end{figure}
...
We conducted an ablation study to isolate the impact of the detector (YuNet) and the recognizer (SFace) independently. We tested four configurations: YuNet + LBPH, Haar Cascade + SFace, Retinaface + Arcface, and the proposed YuNet + SFace.
